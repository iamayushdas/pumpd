...
export function fmtDate(iso: string, long?: boolean): string {
...
export const localTZ = (): string => { try { return Intl.DateTimeFormat().resolvedOptions().timeZone || 'UTC' } catch { return 'UTC' } }
