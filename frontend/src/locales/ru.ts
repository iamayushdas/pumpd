...
export default {
  ...
  "This browser doesn't support passkeys — you can still use pumpd locally on this device.": 'Этот браузер не поддерживает ключи доступа — но pumpd можно использовать локально на этом устройстве.',
  ...
  'to install pumpd as a full-screen app.': 'чтобы установить pumpd как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if pumpd is closed.': 'Оповещения таймера отдыха, даже если pumpd закрыт.',
  ...
  'A small file a friend imports into their own pumpd — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой pumpd — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload pumpd': 'Перезагрузить pumpd',
