...
export default {
  ...
  "This browser doesn't support passkeys — you can still use pumpd locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar pumpd localmente en este dispositivo.',
  ...
  'to install pumpd as a full-screen app.': 'para instalar pumpd como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if pumpd is closed.': 'Avisos del temporizador de descanso, incluso con pumpd cerrado.',
  ...
  'A small file a friend imports into their own pumpd — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio pumpd: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
