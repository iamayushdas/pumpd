...
export default {
  ...
  "This browser doesn't support passkeys — you can still use pumpd locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de pumpd’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'to install pumpd as a full-screen app.': 'ile pumpd’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if pumpd is closed.': 'pumpd kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own pumpd — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi pumpd\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
