...
export default {
  ...
  "This browser doesn't support passkeys — you can still use pumpd locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर pumpd लोकली इस्तेमाल कर सकते हैं।',
  ...
  'to install pumpd as a full-screen app.': 'से pumpd को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if pumpd is closed.': 'आराम टाइमर अलर्ट, pumpd बंद होने पर भी।',
  ...
  'A small file a friend imports into their own pumpd — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने pumpd में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload pumpd': 'pumpd फिर से लोड करें',
