...
export default {
  ...
  "This browser doesn't support passkeys — you can still use pumpd locally on this device.": 'Dieser Browser unterstützt keine Passkeys — du kannst pumpd trotzdem lokal auf diesem Gerät nutzen.',
  ...
  'to install pumpd as a full-screen app.': 'um pumpd als Vollbild-App zu installieren.',
  ...
  'Rest-timer alerts, even if pumpd is closed.': 'Pausen-Timer-Alarm, auch wenn pumpd geschlossen ist.',
  ...
  'A small file a friend imports into their own pumpd — routines only, none of your workouts or weigh-ins.': 'Eine kleine Datei, die ein Freund in sein eigenes pumpd importiert — nur Routinen, keine Workouts oder Wiegungen.',
