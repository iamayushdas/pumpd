...
pumpd is a self-hosted app: you run the server, you hold the data. This file says which
...
<https://github.com/DuarteSantos8/pumpd/security/advisories/new>
...
Read this before hosting pumpd for anyone other than yourself.
...
- **Nothing in `./data` is encrypted.** It holds `db.json` (users, passkey public keys, push
  ...
  `secret` can mint a valid session cookie for any account. **If you host pumpd for other
