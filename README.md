...
<img src="assets/banner.png" alt="pumpd" width="720">
...
<br>
![GitHub last commit](https://img.shields.io/github/last-commit/DuarteSantos8/pumpd?style=flat-square)
[![GitHub stars](https://img.shields.io/github/stars/DuarteSantos8/pumpd?style=flat-square)](https://github.com/DuarteSantos8/pumpd/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/DuarteSantos8/pumpd?style=flat-square)](https://github.com/DuarteSantos8/pumpd/issues)
...
### [🌐 opengym.duarte-santos.ch](https://opengym.duarte-santos.ch) · [▶ Try the live demo](https://duartesantos8.github.io/pumpd/)
...
disappear when the startup does. pumpd is the opposite: **it runs on your box, your data
...
- **Android:** [**download the APK**](https://opengym.duarte-santos.ch) and sideload it —
  pumpd is deliberately not on the Play Store. Or build it yourself: **[docs/MOBILE.md](docs/MOBILE.md)**.
...
| `RP_NAME`     | Name shown in the passkey prompt                     | `pumpd`               |
...
- **[Q&A](https://github.com/DuarteSantos8/pumpd/discussions/categories/q-a)** — self-hosting
  help, passkey/login trouble, "how do I…". Most login problems turn out to be an `RP_ID`/`ORIGIN`
  mismatch.
- **[Ideas](https://github.com/DuarteSantos8/pumpd/discussions/categories/ideas)** — features
  worth talking through before anyone writes code.
- **[Show and tell](https://github.com/DuarteSantos8/pumpd/discussions/categories/show-and-tell)**
  — your setup, your plan templates, whatever you built on top.
- **[Issues](https://github.com/DuarteSantos8/pumpd/issues)** — bugs, and work that's already
  been agreed on.
...
pumpd is free and stays free: AGPL, no subscription, no paid tier, nothing held back for
...
the same license. Nobody can turn pumpd into a closed, proprietary product.
