# Contributing to pumpd

Thanks for taking a look! pumpd is intentionally small and dependency-light, and the goal is
...
| You have | Goes to |
| --- | --- |
| A question, or self-hosting that won't behave | [Discussions → Q&A](https://github.com/DuarteSantos8/pumpd/discussions/categories/q-a) |
| An idea you're not sure about yet | [Discussions → Ideas](https://github.com/DuarteSantos8/pumpd/discussions/categories/ideas) |
| A reproducible bug | [Issues](https://github.com/DuarteSantos8/pumpd/issues) |
